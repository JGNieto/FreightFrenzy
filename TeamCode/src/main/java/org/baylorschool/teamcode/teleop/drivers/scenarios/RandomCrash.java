...
@TeleOp(name="Scenario2", group="Scenario")
public class RandomCrash extends LinearOpMode {
    // In this scenario designed to train drivers, the robot randomly crashes after 1 minute.
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            // SCENARIO
            if (System.currentTimeMillis() - startTime > 45 * 1000) {
                throw new Error("LOSER BOOYA!");
            }
