...
@Autonomous(name = "BlueRightTSENODUCKPark", group = "Blue")
public class BlueRightTSENODUCKPark extends LinearOpMode {
    ...
    public void runOpMode() {
       ...
       // currentLocation = MoveWaypointsEncoders.moveToWaypoints(currentLocation, sensors, Arrays.asList(Places.BlueRightHubToCarousel), this);
        ...
        currentLocation = MoveWaypointsEncoders.moveToWaypoints(currentLocation, sensors, Collections.singletonList(new Location(currentLocation).setHeading(90)), this);
