...
@Autonomous(name = "DWBlueMiddleTSEWarehousePark", group = "Blue")
public class DWBlueMiddleTSEWarehousePark extends LinearOpMode {
    private Lift lift;
    private Mecanum mecanum;
    private TSEPipeline tsePipeline;
    private OpenCvWebcam webcam;
    private IMU imu;
    private Location currentLocation = new Location(Places.blueMiddleStart);
    private Globals.DropLevel dropLevel;
    private Odometry odometry;
    private ElapsedTime elapsedTime;

    private static final Location[] goingToParkStage1 = new Location[] {
            new Location(Places.middle(-.8), Places.closeParallel(2.2), 0),
